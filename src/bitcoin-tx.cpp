...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " yenten-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  yenten-tx [options] <hex-tx> [commands]  Update hex-encoded yenten transaction\n" +
            "or:     yenten-tx [options] -create [commands]   Create hex-encoded yenten transaction\n" +
            "\n";
